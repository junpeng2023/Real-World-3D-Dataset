...
# Example Usage
folder_path = '/media/ziwei/yuankai/json_150_all_in_one'  # Update this to your folder path
...
# Plotting
df_objects.plot(kind='bar', x='Object', y='Count', title='Object Distribution in 150 Videos')
plt.show()
df_objects['Count'].plot(kind='pie', labels=None, figsize=(8, 8), 
                         ...
                         title='Donut diagram of object distribution in 150 videos for training')
