...
# Example Usage
folder_path = '/media/ziwei/yuankai/json_training_120'  # Update this to your folder path
...
# Plotting
df_objects.plot(kind='bar', x='Object', y='Count', title='Object Distribution in 120 Videos')
plt.show()
...
df_objects['Count'].plot(kind='pie', labels=None, figsize=(8, 8), 
                         ...
                         title='Donut diagram of object distribution in 120 videos for training')
