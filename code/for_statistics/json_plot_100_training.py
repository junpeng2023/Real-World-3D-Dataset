...
#action_all_counter('/media/ziwei/yuankai/training_100')
#action_all_counter('/media/ziwei/yuankai/json_train_validation/training_120')

action_all_counter('/media/ziwei/yuankai/json_training_120')
print(action_count_list)
...
df_verbs.plot(kind='bar', title='action distribution in 120 videos for training')
plt.show()
...
df_verbs['Actions'].plot(kind='pie', labels=None, figsize=(8, 8), 
                         ...
                         title='Donut diagram of action distribution in 120 videos for training')
